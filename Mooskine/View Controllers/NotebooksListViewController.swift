...
class NotebooksListViewController: UIViewController, UITableViewDataSource {
    ...
    var fetchedResultsController:NSFetchedResultsController<Notebook>! //opcional desencapsulado
    ...
    func numberOfSections(in tableView: UITableView) -> Int {
        return fetchedResultsController.sections?.count ?? 1 //retorna count, caso contrario 1
    }
    
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return fetchedResultsController.sections?[section].numberOfObjects ?? 0 //retorna numberOfObjects, caso contrario 0
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let vc = segue.destination as? NotesListViewController {
            if let indexPath = tableView.indexPathForSelectedRow {
                ...
                vc.dataController = dataController //instancia DataController
            }
        }
    }
}
